...
class CommercialPaperContract extends Contract {
    ...
    */
    async testissue(ctx, issuer, paperNumber, issueDateTime, maturityDateTime, faceValue) {
   ...
   async query(ctx,args) {
    ...
    console.log("papercontract"+ctx+"args"+args)
    let paper = await ctx.paperList.getPaper(args);
    return paper;
  }
