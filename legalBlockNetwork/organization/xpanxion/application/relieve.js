...
const CommercialPaper = require('../contract/lib/employee.js');
...
async function main() {
    ...
    try {
        ...
        const issueResponse = await contract.submitTransaction('issue', 'Xpanxion', '1122324521XXX', '2020-05-31', '2020-11-30', 'TSDFG1087G');
